...
* [#2684](https://github.com/playbors/playbor-admin-tools/issues/2684) ([#2693](https://github.com/playbors/playbor-admin-tools/issues/2693))
...
* add more tests ([#2410](https://github.com/playbors/playbor-admin-tools/issues/2410))
...
* The validation of tag "options" is not working with int/uint type ([#1969](https://github.com/playbors/playbor-admin-tools/issues/1969))

### Test

* fix fails ([#1970](https://github.com/playbors/playbor-admin-tools/issues/1970))
* make tests stable ([#1968](https://github.com/playbors/playbor-admin-tools/issues/1968))


<a name="tools/goctl/v1.3.6"></a>
## [tools/goctl/v1.3.6](https://github.com/playbors/playbor-admin-tools/compare/v1.3.4...tools/goctl/v1.3.6)

> 2022-06-03

### Chore

* update version ([#1961](https://github.com/playbors/playbor-admin-tools/issues/1961))


<a name="v1.3.4"></a>
## [v1.3.4](https://github.com/playbors/playbor-admin-tools/compare/v1.3.3...v1.3.4)

> 2022-06-03

### Chore

* refactoring mapping string to slice ([#1959](https://github.com/playbors/playbor-admin-tools/issues/1959))
* update roadmap ([#1948](https://github.com/playbors/playbor-admin-tools/issues/1948))
* refine docker for better compatible with package main ([#1944](https://github.com/playbors/playbor-admin-tools/issues/1944))
* add release action to auto build binaries ([#1884](https://github.com/playbors/playbor-admin-tools/issues/1884))
* update k8s.io/client-go for security reason, go is upgrade to 1.16 ([#1912](https://github.com/playbors/playbor-admin-tools/issues/1912))
* use get for quickstart, plain logs for easy understanding ([#1905](https://github.com/playbors/playbor-admin-tools/issues/1905))
* coding style for quickstart ([#1902](https://github.com/playbors/playbor-admin-tools/issues/1902))
* improve codecov ([#1878](https://github.com/playbors/playbor-admin-tools/issues/1878))
* update some logs ([#1875](https://github.com/playbors/playbor-admin-tools/issues/1875))
* fix deprecated usages ([#1871](https://github.com/playbors/playbor-admin-tools/issues/1871))
* refine tests ([#1864](https://github.com/playbors/playbor-admin-tools/issues/1864))
* use time.Now() instead of timex.Time() because go optimized it ([#1860](https://github.com/playbors/playbor-admin-tools/issues/1860))

### Docs

* add docs for logx ([#1960](https://github.com/playbors/playbor-admin-tools/issues/1960))
* update readme ([#1849](https://github.com/playbors/playbor-admin-tools/issues/1849))

### Feat

* update docker alpine package mirror ([#1924](https://github.com/playbors/playbor-admin-tools/issues/1924))
* set default connection idle time for grpc servers ([#1922](https://github.com/playbors/playbor-admin-tools/issues/1922))
* support WithStreamClientInterceptor for zrpc clients ([#1907](https://github.com/playbors/playbor-admin-tools/issues/1907))
* add toml config ([#1899](https://github.com/playbors/playbor-admin-tools/issues/1899))
* Add goctl quickstart ([#1889](https://github.com/playbors/playbor-admin-tools/issues/1889))
* logx with color ([#1872](https://github.com/playbors/playbor-admin-tools/issues/1872))
* Replace cli to cobra ([#1855](https://github.com/playbors/playbor-admin-tools/issues/1855))
* add fields with logx methods, support using third party logging libs. ([#1847](https://github.com/playbors/playbor-admin-tools/issues/1847))

### Fix

* panic on convert to string on fillSliceFromString() ([#1951](https://github.com/playbors/playbor-admin-tools/issues/1951))
* Useless delete cache logic in update ([#1923](https://github.com/playbors/playbor-admin-tools/issues/1923))

### Refactor

* refactor trace in redis & sql & mongo ([#1865](https://github.com/playbors/playbor-admin-tools/issues/1865))

### Test

* add codecov ([#1863](https://github.com/playbors/playbor-admin-tools/issues/1863))
* add codecov ([#1861](https://github.com/playbors/playbor-admin-tools/issues/1861))
* add more tests ([#1856](https://github.com/playbors/playbor-admin-tools/issues/1856))


<a name="v1.3.3"></a>
## [v1.3.3](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.3.5...v1.3.3)

> 2022-04-28


<a name="tools/goctl/v1.3.5"></a>
## [tools/goctl/v1.3.5](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.3.4...tools/goctl/v1.3.5)

> 2022-04-28

### Chhore

* fix usage typo ([#1797](https://github.com/playbors/playbor-admin-tools/issues/1797))

### Chore

* optimize code ([#1818](https://github.com/playbors/playbor-admin-tools/issues/1818))
* remove gofumpt -s flag, default to be enabled ([#1816](https://github.com/playbors/playbor-admin-tools/issues/1816))
* refactor ([#1814](https://github.com/playbors/playbor-admin-tools/issues/1814))
* Embed unit test data ([#1812](https://github.com/playbors/playbor-admin-tools/issues/1812))
* use grpc.WithTransportCredentials and insecure.NewCredentials() instead of grpc.WithInsecure ([#1798](https://github.com/playbors/playbor-admin-tools/issues/1798))
* avoid deadlock after stopping TimingWheel ([#1768](https://github.com/playbors/playbor-admin-tools/issues/1768))
* remove legacy code ([#1766](https://github.com/playbors/playbor-admin-tools/issues/1766))
* add doc ([#1764](https://github.com/playbors/playbor-admin-tools/issues/1764))

### Feat

* Support model code generation for multi tables ([#1836](https://github.com/playbors/playbor-admin-tools/issues/1836))
* support sub domain for cors ([#1827](https://github.com/playbors/playbor-admin-tools/issues/1827))
* upgrade grpc to 1.46, and remove the deprecated grpc.WithBalancerName ([#1820](https://github.com/playbors/playbor-admin-tools/issues/1820))
* add trace in redis & mon & sql ([#1799](https://github.com/playbors/playbor-admin-tools/issues/1799))
* use mongodb official driver instead of mgo ([#1782](https://github.com/playbors/playbor-admin-tools/issues/1782))
* add httpc.Do & httpc.Service.Do ([#1775](https://github.com/playbors/playbor-admin-tools/issues/1775))
* add goctl docker build scripts ([#1760](https://github.com/playbors/playbor-admin-tools/issues/1760))
* support ctx in kv methods ([#1759](https://github.com/playbors/playbor-admin-tools/issues/1759))
* use go:embed to embed templates ([#1756](https://github.com/playbors/playbor-admin-tools/issues/1756))

### Fix

* remove deprecated dependencies ([#1837](https://github.com/playbors/playbor-admin-tools/issues/1837))
* rest: WriteJson get 200 when Marshal failed. ([#1803](https://github.com/playbors/playbor-admin-tools/issues/1803))
* Fix issue [#1810](https://github.com/playbors/playbor-admin-tools/issues/1810) ([#1811](https://github.com/playbors/playbor-admin-tools/issues/1811))
* ignore timeout on websocket ([#1802](https://github.com/playbors/playbor-admin-tools/issues/1802))
* Hdel check result & Pfadd check result ([#1801](https://github.com/playbors/playbor-admin-tools/issues/1801))
* model unique keys generated differently in each re-generation ([#1771](https://github.com/playbors/playbor-admin-tools/issues/1771))

### Refactor

* move json related header vars to internal ([#1840](https://github.com/playbors/playbor-admin-tools/issues/1840))
* simplify the code ([#1835](https://github.com/playbors/playbor-admin-tools/issues/1835))
* move postgres to pg package ([#1781](https://github.com/playbors/playbor-admin-tools/issues/1781))


<a name="tools/goctl/v1.3.4"></a>
## [tools/goctl/v1.3.4](https://github.com/playbors/playbor-admin-tools/compare/v1.3.2...tools/goctl/v1.3.4)

> 2022-04-03

### Chore

* update go-zero to v1.3.2 in goctl ([#1750](https://github.com/playbors/playbor-admin-tools/issues/1750))


<a name="v1.3.2"></a>
## [v1.3.2](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.3.3...v1.3.2)

> 2022-04-03

### Chore

* update goctl version to 1.3.4 ([#1742](https://github.com/playbors/playbor-admin-tools/issues/1742))
* refactor to use const instead of var ([#1731](https://github.com/playbors/playbor-admin-tools/issues/1731))
* refactor code ([#1708](https://github.com/playbors/playbor-admin-tools/issues/1708))
* refactor code ([#1700](https://github.com/playbors/playbor-admin-tools/issues/1700))
* refactor code ([#1699](https://github.com/playbors/playbor-admin-tools/issues/1699))
* fix lint issue ([#1694](https://github.com/playbors/playbor-admin-tools/issues/1694))

### Feat

* simplify httpc ([#1748](https://github.com/playbors/playbor-admin-tools/issues/1748))
* return original value of setbit in redis ([#1746](https://github.com/playbors/playbor-admin-tools/issues/1746))
* let model customizable ([#1738](https://github.com/playbors/playbor-admin-tools/issues/1738))
* remove reentrance in redislock, timeout bug ([#1704](https://github.com/playbors/playbor-admin-tools/issues/1704))
* add getset command in redis and kv ([#1693](https://github.com/playbors/playbor-admin-tools/issues/1693))
* add httpc.Parse ([#1698](https://github.com/playbors/playbor-admin-tools/issues/1698))
* support -base to specify base image for goctl docker ([#1668](https://github.com/playbors/playbor-admin-tools/issues/1668))
* add Dockerfile for goctl ([#1666](https://github.com/playbors/playbor-admin-tools/issues/1666))
* Remove  command `goctl rpc proto`  ([#1665](https://github.com/playbors/playbor-admin-tools/issues/1665))

### Fix

* model generation bug on with cache ([#1743](https://github.com/playbors/playbor-admin-tools/issues/1743))
* empty slice are set to nil ([#1702](https://github.com/playbors/playbor-admin-tools/issues/1702))
* the new  RawFieldNames considers the tag with options. ([#1663](https://github.com/playbors/playbor-admin-tools/issues/1663))

### Refactor

* guard timeout on API files ([#1726](https://github.com/playbors/playbor-admin-tools/issues/1726))
* simplify the code ([#1670](https://github.com/playbors/playbor-admin-tools/issues/1670))


<a name="tools/goctl/v1.3.3"></a>
## [tools/goctl/v1.3.3](https://github.com/playbors/playbor-admin-tools/compare/v1.3.1...tools/goctl/v1.3.3)

> 2022-03-17

### Chore

* remove unnecessary env ([#1654](https://github.com/playbors/playbor-admin-tools/issues/1654))
* reduce the docker image size ([#1633](https://github.com/playbors/playbor-admin-tools/issues/1633))
* update goctl version to 1.3.3, change docker build temp dir ([#1621](https://github.com/playbors/playbor-admin-tools/issues/1621))
* refactor code ([#1613](https://github.com/playbors/playbor-admin-tools/issues/1613))
* add unit tests ([#1615](https://github.com/playbors/playbor-admin-tools/issues/1615))
* update go-zero to v1.3.1 in goctl ([#1599](https://github.com/playbors/playbor-admin-tools/issues/1599))

### Feat

* add httpc/Service for convinience ([#1641](https://github.com/playbors/playbor-admin-tools/issues/1641))
* add httpc/Get httpc/Post ([#1640](https://github.com/playbors/playbor-admin-tools/issues/1640))
* add rest/httpc to make http requests governacible ([#1638](https://github.com/playbors/playbor-admin-tools/issues/1638))
* support cpu stat on cgroups v2 ([#1636](https://github.com/playbors/playbor-admin-tools/issues/1636))
* support oracle :N dynamic parameters ([#1552](https://github.com/playbors/playbor-admin-tools/issues/1552))
* support scratch as the base docker image ([#1634](https://github.com/playbors/playbor-admin-tools/issues/1634))

### Fix

* typo ([#1646](https://github.com/playbors/playbor-admin-tools/issues/1646))
* Update unix-like path regex ([#1637](https://github.com/playbors/playbor-admin-tools/issues/1637))
* HitQuota should be returned instead of Allowed when limit is equal to 1. ([#1581](https://github.com/playbors/playbor-admin-tools/issues/1581))
* fix(gctl): apiparser_parser auto format ([#1607](https://github.com/playbors/playbor-admin-tools/issues/1607))

### Refactor

* httpc package for easy to use ([#1645](https://github.com/playbors/playbor-admin-tools/issues/1645))
* httpc package for easy to use ([#1643](https://github.com/playbors/playbor-admin-tools/issues/1643))

### Test

* add more tests ([#1604](https://github.com/playbors/playbor-admin-tools/issues/1604))


<a name="v1.3.1"></a>
## [v1.3.1](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.3.2...v1.3.1)

> 2022-03-01

### Build

* update goctl dependency ddl-parser to v1.0.3 ([#1586](https://github.com/playbors/playbor-admin-tools/issues/1586))

### Chore

* upgrade etcd ([#1597](https://github.com/playbors/playbor-admin-tools/issues/1597))
* fix data race ([#1593](https://github.com/playbors/playbor-admin-tools/issues/1593))
* add goctl command help ([#1578](https://github.com/playbors/playbor-admin-tools/issues/1578))
* update help message ([#1544](https://github.com/playbors/playbor-admin-tools/issues/1544))

### Docs

* add go-zero users ([#1546](https://github.com/playbors/playbor-admin-tools/issues/1546))
* update roadmap ([#1537](https://github.com/playbors/playbor-admin-tools/issues/1537))

### Feat

* supports `importValue` for more path formats ([#1569](https://github.com/playbors/playbor-admin-tools/issues/1569))
* support pg serial type for auto_increment ([#1563](https://github.com/playbors/playbor-admin-tools/issues/1563))
* log 404 requests with traceid ([#1554](https://github.com/playbors/playbor-admin-tools/issues/1554))
* support ctx in sql model generation ([#1551](https://github.com/playbors/playbor-admin-tools/issues/1551))
* support ctx in sqlx/sqlc, listed in ROADMAP ([#1535](https://github.com/playbors/playbor-admin-tools/issues/1535))

### Feature

* Add goctl env ([#1557](https://github.com/playbors/playbor-admin-tools/issues/1557))

### Fix

* goctl api dart support `form` tag ([#1596](https://github.com/playbors/playbor-admin-tools/issues/1596))

### Test

* add testcase for FIFO Queue in collection module ([#1589](https://github.com/playbors/playbor-admin-tools/issues/1589))


<a name="tools/goctl/v1.3.2"></a>
## [tools/goctl/v1.3.2](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.3.0...tools/goctl/v1.3.2)

> 2022-02-14

### Chore

* refactor cache ([#1532](https://github.com/playbors/playbor-admin-tools/issues/1532))
* goctl format issue ([#1531](https://github.com/playbors/playbor-admin-tools/issues/1531))
* update goctl version to 1.3.2 ([#1524](https://github.com/playbors/playbor-admin-tools/issues/1524))

### Feat

* support ctx in `Cache` ([#1518](https://github.com/playbors/playbor-admin-tools/issues/1518))

### Fix

* fix a typo ([#1522](https://github.com/playbors/playbor-admin-tools/issues/1522))


<a name="tools/goctl/v1.3.0"></a>
## [tools/goctl/v1.3.0](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.3.1...tools/goctl/v1.3.0)

> 2022-02-09

### Chore

* optimize yaml unmarshaler ([#1513](https://github.com/playbors/playbor-admin-tools/issues/1513))
* make error clearer ([#1514](https://github.com/playbors/playbor-admin-tools/issues/1514))
* update command comment ([#1501](https://github.com/playbors/playbor-admin-tools/issues/1501))

### Ci

* add test for win ([#1503](https://github.com/playbors/playbor-admin-tools/issues/1503))

### Feat

* update go-redis to v8, support ctx in redis methods ([#1507](https://github.com/playbors/playbor-admin-tools/issues/1507))

### Feature

* Add `goctl completion` ([#1505](https://github.com/playbors/playbor-admin-tools/issues/1505))

### Refactor

* refactor yaml unmarshaler ([#1517](https://github.com/playbors/playbor-admin-tools/issues/1517))

### Test

* change fuzz tests ([#1504](https://github.com/playbors/playbor-admin-tools/issues/1504))


<a name="tools/goctl/v1.3.1"></a>
## [tools/goctl/v1.3.1](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.3.1-alpha...tools/goctl/v1.3.1)

> 2022-02-01


<a name="tools/goctl/v1.3.1-alpha"></a>
## [tools/goctl/v1.3.1-alpha](https://github.com/playbors/playbor-admin-tools/compare/v1.3.0...tools/goctl/v1.3.1-alpha)

> 2022-02-01

### Docs

* update tal-tech to zeromico in docs ([#1498](https://github.com/playbors/playbor-admin-tools/issues/1498))

### Fix

* goctl not compile on windows ([#1500](https://github.com/playbors/playbor-admin-tools/issues/1500))


<a name="v1.3.0"></a>
## [v1.3.0](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.3.0-beta1...v1.3.0)

> 2022-02-01

### Chore

* update goctl version ([#1497](https://github.com/playbors/playbor-admin-tools/issues/1497))
* improve migrate confirmation ([#1488](https://github.com/playbors/playbor-admin-tools/issues/1488))

### Feat

* add runtime stats monitor ([#1496](https://github.com/playbors/playbor-admin-tools/issues/1496))
* handling panic in mapreduce, panic in calling goroutine, not inside goroutines ([#1490](https://github.com/playbors/playbor-admin-tools/issues/1490))

### Fix

* goroutine stuck on edge case ([#1495](https://github.com/playbors/playbor-admin-tools/issues/1495))


<a name="tools/goctl/v1.3.0-beta1"></a>
## [tools/goctl/v1.3.0-beta1](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.3.0-alpha...tools/goctl/v1.3.0-beta1)

> 2022-01-26

### Chore

* update warning message ([#1487](https://github.com/playbors/playbor-admin-tools/issues/1487))
* update go version for goctl ([#1484](https://github.com/playbors/playbor-admin-tools/issues/1484))

### Patch

* goctl migrate ([#1485](https://github.com/playbors/playbor-admin-tools/issues/1485))


<a name="tools/goctl/v1.3.0-alpha"></a>
## [tools/goctl/v1.3.0-alpha](https://github.com/playbors/playbor-admin-tools/compare/v1.3.0-beta...tools/goctl/v1.3.0-alpha)

> 2022-01-25

### Refactor

* rename from tal-tech to zeromicro for goctl ([#1481](https://github.com/playbors/playbor-admin-tools/issues/1481))


<a name="v1.3.0-beta"></a>
## [v1.3.0-beta](https://github.com/playbors/playbor-admin-tools/compare/v1.3.0-alpha...v1.3.0-beta)

> 2022-01-25

### Chore

* optimize string search with Aho–Corasick algorithm ([#1476](https://github.com/playbors/playbor-admin-tools/issues/1476))
* update unauthorized callback calling order ([#1469](https://github.com/playbors/playbor-admin-tools/issues/1469))
* check interface satisfaction w/o allocating new variable ([#1454](https://github.com/playbors/playbor-admin-tools/issues/1454))
* remove jwt deprecated ([#1452](https://github.com/playbors/playbor-admin-tools/issues/1452))
* upgrade dependencies ([#1444](https://github.com/playbors/playbor-admin-tools/issues/1444))
* fix typo ([#1437](https://github.com/playbors/playbor-admin-tools/issues/1437))
* refactor periodlimit ([#1428](https://github.com/playbors/playbor-admin-tools/issues/1428))

### Ci

* add translator action ([#1441](https://github.com/playbors/playbor-admin-tools/issues/1441))

### Docs

* add go-zero users ([#1473](https://github.com/playbors/playbor-admin-tools/issues/1473))
* add go-zero users ([#1425](https://github.com/playbors/playbor-admin-tools/issues/1425))
* add go-zero users ([#1424](https://github.com/playbors/playbor-admin-tools/issues/1424))
* update install readme ([#1417](https://github.com/playbors/playbor-admin-tools/issues/1417))

### Feat

* implement console plain output for debug logs ([#1456](https://github.com/playbors/playbor-admin-tools/issues/1456))
* 支持redis的LTrim方法 ([#1443](https://github.com/playbors/playbor-admin-tools/issues/1443))
* Add migrate ([#1419](https://github.com/playbors/playbor-admin-tools/issues/1419))

### Fix

* mr goroutine leak on context deadline ([#1433](https://github.com/playbors/playbor-admin-tools/issues/1433))
* golint issue ([#1423](https://github.com/playbors/playbor-admin-tools/issues/1423))

### Patch

* save missing templates to disk ([#1463](https://github.com/playbors/playbor-admin-tools/issues/1463))


<a name="v1.3.0-alpha"></a>
## [v1.3.0-alpha](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.2.5...v1.3.0-alpha)

> 2022-01-05

### Chore

* refactor rest/timeouthandler ([#1415](https://github.com/playbors/playbor-admin-tools/issues/1415))

### Feat

* rename module from tal-tech to zeromicro ([#1413](https://github.com/playbors/playbor-admin-tools/issues/1413))


<a name="tools/goctl/v1.2.5"></a>
## [tools/goctl/v1.2.5](https://github.com/playbors/playbor-admin-tools/compare/v1.2.5...tools/goctl/v1.2.5)

> 2022-01-03

### Chore

* update go-zero to v1.2.5 ([#1410](https://github.com/playbors/playbor-admin-tools/issues/1410))


<a name="v1.2.5"></a>
## [v1.2.5](https://github.com/playbors/playbor-admin-tools/compare/tools/goctl/v1.2.4...v1.2.5)

> 2022-01-02

### Chore

* simplify mapreduce ([#1401](https://github.com/playbors/playbor-admin-tools/issues/1401))
* fix golint issues ([#1396](https://github.com/playbors/playbor-admin-tools/issues/1396))
* update goctl version ([#1394](https://github.com/playbors/playbor-admin-tools/issues/1394))

### Ci

* remove 386 binaries ([#1393](https://github.com/playbors/playbor-admin-tools/issues/1393))

### Docs

* update roadmap ([#1405](https://github.com/playbors/playbor-admin-tools/issues/1405))
* update goctl installation command ([#1403](https://github.com/playbors/playbor-admin-tools/issues/1403))

### Feat

* support tls for etcd client ([#1390](https://github.com/playbors/playbor-admin-tools/issues/1390))
* implement fx.NoneMatch, fx.First, fx.Last ([#1402](https://github.com/playbors/playbor-admin-tools/issues/1402))

### Refactor

* optimize fx ([#1404](https://github.com/playbors/playbor-admin-tools/issues/1404))


<a name="tools/goctl/v1.2.4"></a>
## [tools/goctl/v1.2.4](https://github.com/playbors/playbor-admin-tools/compare/v1.2.4...tools/goctl/v1.2.4)

> 2021-12-30

### Chore

* update goctl version to 1.2.4 for release tools/goctl/v1.2.4 ([#1372](https://github.com/playbors/playbor-admin-tools/issues/1372))
* add 1s for tolerance in redislock ([#1367](https://github.com/playbors/playbor-admin-tools/issues/1367))
* coding style and comments ([#1361](https://github.com/playbors/playbor-admin-tools/issues/1361))
* optimize `ParseJsonBody` ([#1353](https://github.com/playbors/playbor-admin-tools/issues/1353))
* put error message in error.log for verbose mode ([#1355](https://github.com/playbors/playbor-admin-tools/issues/1355))
* add tests & refactor ([#1346](https://github.com/playbors/playbor-admin-tools/issues/1346))
* add comments ([#1345](https://github.com/playbors/playbor-admin-tools/issues/1345))
* update goctl version to 1.2.5 ([#1337](https://github.com/playbors/playbor-admin-tools/issues/1337))
* refactor ([#1331](https://github.com/playbors/playbor-admin-tools/issues/1331))
* format code ([#1327](https://github.com/playbors/playbor-admin-tools/issues/1327))
* rename service context from ctx to svcCtx ([#1299](https://github.com/playbors/playbor-admin-tools/issues/1299))
* update cli version ([#1287](https://github.com/playbors/playbor-admin-tools/issues/1287))

### Chose

* cancel the assignment and judge later ([#1359](https://github.com/playbors/playbor-admin-tools/issues/1359))

### Ci

* remove windows 386 binary ([#1392](https://github.com/playbors/playbor-admin-tools/issues/1392))
* add release action to auto build binaries ([#1371](https://github.com/playbors/playbor-admin-tools/issues/1371))

### Docs

* add go-zero users ([#1381](https://github.com/playbors/playbor-admin-tools/issues/1381))
* update slack invitation link ([#1378](https://github.com/playbors/playbor-admin-tools/issues/1378))
* update goctl markdown ([#1370](https://github.com/playbors/playbor-admin-tools/issues/1370))
* add go-zero users ([#1323](https://github.com/playbors/playbor-admin-tools/issues/1323))
* add go-zero users ([#1294](https://github.com/playbors/playbor-admin-tools/issues/1294))

### Feat

* Add --remote ([#1387](https://github.com/playbors/playbor-admin-tools/issues/1387))
* support array in default and options tags ([#1386](https://github.com/playbors/playbor-admin-tools/issues/1386))
* support context in MapReduce ([#1368](https://github.com/playbors/playbor-admin-tools/issues/1368))
* treat client closed requests as code 499 ([#1350](https://github.com/playbors/playbor-admin-tools/issues/1350))
* tidy mod, update go-zero to latest ([#1334](https://github.com/playbors/playbor-admin-tools/issues/1334))
* tidy mod, update go-zero to latest ([#1333](https://github.com/playbors/playbor-admin-tools/issues/1333))
* tidy mod, add go.mod for goctl ([#1328](https://github.com/playbors/playbor-admin-tools/issues/1328))
* reduce dependencies of framework by add go.mod in goctl ([#1290](https://github.com/playbors/playbor-admin-tools/issues/1290))

### Feature

* support adding custom cache to mongoc and sqlc ([#1313](https://github.com/playbors/playbor-admin-tools/issues/1313))

### Fix

*  command system info missing go version ([#1377](https://github.com/playbors/playbor-admin-tools/issues/1377))
* [#1318](https://github.com/playbors/playbor-admin-tools/issues/1318) ([#1321](https://github.com/playbors/playbor-admin-tools/issues/1321))
* go issue 16206 ([#1298](https://github.com/playbors/playbor-admin-tools/issues/1298))

### Style

* format code ([#1322](https://github.com/playbors/playbor-admin-tools/issues/1322))

### Test

* add more tests ([#1391](https://github.com/playbors/playbor-admin-tools/issues/1391))
* add more tests ([#1352](https://github.com/playbors/playbor-admin-tools/issues/1352))


<a name="v1.2.4"></a>
## [v1.2.4](https://github.com/playbors/playbor-admin-tools/compare/v1.2.3...v1.2.4)

> 2021-12-01

### Chore

* cleanup zRPC retry code ([#1280](https://github.com/playbors/playbor-admin-tools/issues/1280))
* only allow cors middleware to change headers ([#1276](https://github.com/playbors/playbor-admin-tools/issues/1276))
* avoid superfluous WriteHeader call errors ([#1275](https://github.com/playbors/playbor-admin-tools/issues/1275))
* update goctl version ([#1250](https://github.com/playbors/playbor-admin-tools/issues/1250))

### Docs

* update readme to use goctl[@cli](https://github.com/cli) ([#1255](https://github.com/playbors/playbor-admin-tools/issues/1255))

### Feat

* support third party orm to interact with go-zero ([#1286](https://github.com/playbors/playbor-admin-tools/issues/1286))
* add etcd resolver scheme, fix discov minor issue ([#1281](https://github.com/playbors/playbor-admin-tools/issues/1281))
* support %w in logx.Errorf ([#1278](https://github.com/playbors/playbor-admin-tools/issues/1278))
* add rest.WithCustomCors to let caller customize the response ([#1274](https://github.com/playbors/playbor-admin-tools/issues/1274))


<a name="v1.2.3"></a>
## [v1.2.3](https://github.com/playbors/playbor-admin-tools/compare/v1.2.2...v1.2.3)

> 2021-11-15

### Chore

* remove conf.CheckedDuration ([#1235](https://github.com/playbors/playbor-admin-tools/issues/1235))
* refactor, better goctl message ([#1228](https://github.com/playbors/playbor-admin-tools/issues/1228))
* remove unused const ([#1224](https://github.com/playbors/playbor-admin-tools/issues/1224))
* redislock use stringx.randn replace randomStr func ([#1220](https://github.com/playbors/playbor-admin-tools/issues/1220))
* refine code ([#1215](https://github.com/playbors/playbor-admin-tools/issues/1215))
* remove semicolon for routes of services in api files ([#1195](https://github.com/playbors/playbor-admin-tools/issues/1195))
* update goctl version to 1.2.3, prepare for release ([#1193](https://github.com/playbors/playbor-admin-tools/issues/1193))
* reorg imports, format code, make MaxRetires default to 0 ([#1165](https://github.com/playbors/playbor-admin-tools/issues/1165))
* reverse the order of stopping services ([#1159](https://github.com/playbors/playbor-admin-tools/issues/1159))

### Docs

* add go-zero users ([#1214](https://github.com/playbors/playbor-admin-tools/issues/1214))
* update roadmap ([#1184](https://github.com/playbors/playbor-admin-tools/issues/1184))
* update roadmap ([#1178](https://github.com/playbors/playbor-admin-tools/issues/1178))
* add go-zero users ([#1176](https://github.com/playbors/playbor-admin-tools/issues/1176))
* add go-zero users ([#1172](https://github.com/playbors/playbor-admin-tools/issues/1172))
* update qr code ([#1158](https://github.com/playbors/playbor-admin-tools/issues/1158))
* add go-zero users ([#1141](https://github.com/playbors/playbor-admin-tools/issues/1141))
* add go-zero users ([#1135](https://github.com/playbors/playbor-admin-tools/issues/1135))
* add go-zero users ([#1130](https://github.com/playbors/playbor-admin-tools/issues/1130))

### Feat

* enable retry for zrpc ([#1237](https://github.com/playbors/playbor-admin-tools/issues/1237))
* disable grpc retry, enable it in v1.2.4 ([#1233](https://github.com/playbors/playbor-admin-tools/issues/1233))
* exit with non-zero code on errors ([#1218](https://github.com/playbors/playbor-admin-tools/issues/1218))
* support CORS, better implementation ([#1217](https://github.com/playbors/playbor-admin-tools/issues/1217))
* support CORS by using rest.WithCors(...) ([#1212](https://github.com/playbors/playbor-admin-tools/issues/1212))
* ignore rest.WithPrefix on empty prefix ([#1208](https://github.com/playbors/playbor-admin-tools/issues/1208))
* support customizing timeout for specific route ([#1203](https://github.com/playbors/playbor-admin-tools/issues/1203))
* add NewSessionFromTx to interact with other orm ([#1202](https://github.com/playbors/playbor-admin-tools/issues/1202))
* simplify the grpc tls authentication ([#1199](https://github.com/playbors/playbor-admin-tools/issues/1199))
* use WithBlock() by default, NonBlock can be set in config or WithNonBlock() ([#1198](https://github.com/playbors/playbor-admin-tools/issues/1198))
* add rest.WithPrefix to support route prefix ([#1194](https://github.com/playbors/playbor-admin-tools/issues/1194))
* slow threshold customizable in zrpc ([#1191](https://github.com/playbors/playbor-admin-tools/issues/1191))
* slow threshold customizable in rest ([#1189](https://github.com/playbors/playbor-admin-tools/issues/1189))
* slow threshold customizable in sqlx ([#1188](https://github.com/playbors/playbor-admin-tools/issues/1188))
* slow threshold customizable in redis ([#1187](https://github.com/playbors/playbor-admin-tools/issues/1187))
* slow threshold customizable in mongo ([#1186](https://github.com/playbors/playbor-admin-tools/issues/1186))
* slow threshold customizable in redis ([#1185](https://github.com/playbors/playbor-admin-tools/issues/1185))
* support multiple trace agents ([#1183](https://github.com/playbors/playbor-admin-tools/issues/1183))
* let different services start prometheus on demand ([#1182](https://github.com/playbors/playbor-admin-tools/issues/1182))
* support auth account for etcd ([#1174](https://github.com/playbors/playbor-admin-tools/issues/1174))
* support ssl on zrpc, simplify the config ([#1175](https://github.com/playbors/playbor-admin-tools/issues/1175))

### Refactor

* simplify tls config in rest ([#1181](https://github.com/playbors/playbor-admin-tools/issues/1181))

### Test

* add more tests ([#1209](https://github.com/playbors/playbor-admin-tools/issues/1209))
* add more tests ([#1179](https://github.com/playbors/playbor-admin-tools/issues/1179))
* add more tests ([#1166](https://github.com/playbors/playbor-admin-tools/issues/1166))
* add more tests ([#1163](https://github.com/playbors/playbor-admin-tools/issues/1163))
* add more tests ([#1154](https://github.com/playbors/playbor-admin-tools/issues/1154))
* add more tests ([#1150](https://github.com/playbors/playbor-admin-tools/issues/1150))
* add more tests ([#1149](https://github.com/playbors/playbor-admin-tools/issues/1149))
* add more tests ([#1147](https://github.com/playbors/playbor-admin-tools/issues/1147))
* add more tests ([#1138](https://github.com/playbors/playbor-admin-tools/issues/1138))
* add more tests ([#1137](https://github.com/playbors/playbor-admin-tools/issues/1137))
* add more tests ([#1134](https://github.com/playbors/playbor-admin-tools/issues/1134))


<a name="v1.2.2"></a>
## [v1.2.2](https://github.com/playbors/playbor-admin-tools/compare/v1.2.1...v1.2.2)

> 2021-10-12

### Chore

* refine rpc template in goctl ([#1129](https://github.com/playbors/playbor-admin-tools/issues/1129))
* replace redis.NewRedis with redis.New ([#1103](https://github.com/playbors/playbor-admin-tools/issues/1103))
* mark redis.NewRedis as Deprecated, use redis.New instead. ([#1100](https://github.com/playbors/playbor-admin-tools/issues/1100))
* run unit test with go 1.14 ([#1084](https://github.com/playbors/playbor-admin-tools/issues/1084))
* when run goctl-rpc, the order of proto message aliases should be ([#1078](https://github.com/playbors/playbor-admin-tools/issues/1078))
* fix comment issues ([#1056](https://github.com/playbors/playbor-admin-tools/issues/1056))
* make comment accurate ([#1055](https://github.com/playbors/playbor-admin-tools/issues/1055))

### Ci

* add reviewdog ([#1096](https://github.com/playbors/playbor-admin-tools/issues/1096))
* accurate error reporting on lint check ([#1089](https://github.com/playbors/playbor-admin-tools/issues/1089))
* add Lint check on commits ([#1086](https://github.com/playbors/playbor-admin-tools/issues/1086))

### Docs

* update roadmap ([#1110](https://github.com/playbors/playbor-admin-tools/issues/1110))
* update roadmap ([#1094](https://github.com/playbors/playbor-admin-tools/issues/1094))
* update roadmap ([#1093](https://github.com/playbors/playbor-admin-tools/issues/1093))
* change organization from tal-tech to zeromicro in readme ([#1087](https://github.com/playbors/playbor-admin-tools/issues/1087))

### Feat

* opentelemetry integration, removed self designed tracing ([#1111](https://github.com/playbors/playbor-admin-tools/issues/1111))
* reflection grpc service ([#1107](https://github.com/playbors/playbor-admin-tools/issues/1107))

### Fix

* opentelemetry traceid not correct ([#1108](https://github.com/playbors/playbor-admin-tools/issues/1108))

### Test

* add more tests ([#1119](https://github.com/playbors/playbor-admin-tools/issues/1119))
* add more tests ([#1112](https://github.com/playbors/playbor-admin-tools/issues/1112))
* add more tests ([#1106](https://github.com/playbors/playbor-admin-tools/issues/1106))


<a name="v1.2.1"></a>
## [v1.2.1](https://github.com/playbors/playbor-admin-tools/compare/v1.2.0...v1.2.1)

> 2021-09-14


<a name="v1.2.0"></a>
## [v1.2.0](https://github.com/playbors/playbor-admin-tools/compare/v1.1.10...v1.2.0)

> 2021-09-13

### Feat

* change logger to traceLogger for getting traceId when recovering ([#374](https://github.com/playbors/playbor-admin-tools/issues/374))

### Fix

* 解决golint 部分警告 ([#897](https://github.com/playbors/playbor-admin-tools/issues/897))

### Pull Requests

* Merge pull request [#1023](https://github.com/playbors/playbor-admin-tools/issues/1023) from anqiansong/1014-rollback


<a name="v1.1.10"></a>
## [v1.1.10](https://github.com/playbors/playbor-admin-tools/compare/v1.1.9...v1.1.10)

> 2021-08-04


<a name="v1.1.9"></a>
## [v1.1.9](https://github.com/playbors/playbor-admin-tools/compare/v1.1.8...v1.1.9)

> 2021-08-01


<a name="v1.1.8"></a>
## [v1.1.8](https://github.com/playbors/playbor-admin-tools/compare/v1.1.7...v1.1.8)

> 2021-06-23

### Fix

* Fix problems with non support for multidimensional arrays and basic type pointer arrays ([#778](https://github.com/playbors/playbor-admin-tools/issues/778))


<a name="v1.1.7"></a>
## [v1.1.7](https://github.com/playbors/playbor-admin-tools/compare/v1.1.6...v1.1.7)

> 2021-05-08

### Chore

* update code format. ([#628](https://github.com/playbors/playbor-admin-tools/issues/628))

### Doc

* fix spell mistake ([#627](https://github.com/playbors/playbor-admin-tools/issues/627))


<a name="v1.1.6"></a>
## [v1.1.6](https://github.com/playbors/playbor-admin-tools/compare/v1.1.5...v1.1.6)

> 2021-03-27


<a name="v1.1.5"></a>
## [v1.1.5](https://github.com/playbors/playbor-admin-tools/compare/v1.1.4...v1.1.5)

> 2021-03-02


<a name="v1.1.4"></a>
## [v1.1.4](https://github.com/playbors/playbor-admin-tools/compare/v1.1.3-pre...v1.1.4)

> 2021-01-16


<a name="v1.1.3-pre"></a>
## [v1.1.3-pre](https://github.com/playbors/playbor-admin-tools/compare/v1.1.3-beta...v1.1.3-pre)

> 2021-01-13


<a name="v1.1.3-beta"></a>
## [v1.1.3-beta](https://github.com/playbors/playbor-admin-tools/compare/v1.1.3...v1.1.3-beta)

> 2021-01-13


<a name="v1.1.3"></a>
## [v1.1.3](https://github.com/playbors/playbor-admin-tools/compare/v1.1.2...v1.1.3)

> 2021-01-13

### Feature

* refactor api parse to g4 ([#365](https://github.com/playbors/playbor-admin-tools/issues/365))


<a name="v1.1.2"></a>
## [v1.1.2](https://github.com/playbors/playbor-admin-tools/compare/v1.1.1...v1.1.2)

> 2021-01-05


<a name="v1.1.1"></a>
## [v1.1.1](https://github.com/playbors/playbor-admin-tools/compare/v1.1.0...v1.1.1)

> 2020-12-12


<a name="v1.1.0"></a>
## [v1.1.0](https://github.com/playbors/playbor-admin-tools/compare/v1.0.29...v1.1.0)

> 2020-12-09


<a name="v1.0.29"></a>
## [v1.0.29](https://github.com/playbors/playbor-admin-tools/compare/v1.0.28...v1.0.29)

> 2020-11-28

### Feature

* file namestyle ([#223](https://github.com/playbors/playbor-admin-tools/issues/223))


<a name="v1.0.28"></a>
## [v1.0.28](https://github.com/playbors/playbor-admin-tools/compare/v1.0.27...v1.0.28)

> 2020-11-19


<a name="v1.0.27"></a>
## [v1.0.27](https://github.com/playbors/playbor-admin-tools/compare/v1.0.26...v1.0.27)

> 2020-11-13


<a name="v1.0.26"></a>
## [v1.0.26](https://github.com/playbors/playbor-admin-tools/compare/v1.0.25...v1.0.26)

> 2020-11-08


<a name="v1.0.25"></a>
## [v1.0.25](https://github.com/playbors/playbor-admin-tools/compare/v1.0.24...v1.0.25)

> 2020-11-05


<a name="v1.0.24"></a>
## [v1.0.24](https://github.com/playbors/playbor-admin-tools/compare/v1.0.23...v1.0.24)

> 2020-11-05


<a name="v1.0.23"></a>
## [v1.0.23](https://github.com/playbors/playbor-admin-tools/compare/v1.0.22...v1.0.23)

> 2020-10-28

### Docs

* format markdown and add go mod in demo ([#155](https://github.com/playbors/playbor-admin-tools/issues/155))


<a name="v1.0.22"></a>
## [v1.0.22](https://github.com/playbors/playbor-admin-tools/compare/v1.0.21...v1.0.22)

> 2020-10-21


<a name="v1.0.21"></a>
## [v1.0.21](https://github.com/playbors/playbor-admin-tools/compare/v1.0.20...v1.0.21)

> 2020-10-17

### Fix

* fx/fn.Head func will forever block when n is less than 1 ([#128](https://github.com/playbors/playbor-admin-tools/issues/128))
* template cache key ([#121](https://github.com/playbors/playbor-admin-tools/issues/121))


<a name="v1.0.20"></a>
## [v1.0.20](https://github.com/playbors/playbor-admin-tools/compare/v1.0.19...v1.0.20)

> 2020-10-10


<a name="v1.0.19"></a>
## [v1.0.19](https://github.com/playbors/playbor-admin-tools/compare/v1.0.18...v1.0.19)

> 2020-10-04

### Breaker

* remover useless code ([#114](https://github.com/playbors/playbor-admin-tools/issues/114))

### Update

* fix wrong word ([#110](https://github.com/playbors/playbor-admin-tools/issues/110))


<a name="v1.0.18"></a>
## [v1.0.18](https://github.com/playbors/playbor-admin-tools/compare/v1.0.17...v1.0.18)

> 2020-09-29

### Doc

* update sharedcalls.md layout ([#107](https://github.com/playbors/playbor-admin-tools/issues/107))
...
<a name="v1.0.17"></a>
## [v1.0.17](https://github.com/playbors/playbor-admin-tools/compare/v1.0.16...v1.0.17)

> 2020-09-28


<a name="v1.0.16"></a>
## [v1.0.16](https://github.com/playbors/playbor-admin-tools/compare/v1.0.15...v1.0.16)

> 2020-09-22

### Chore

* fix typos ([#85](https://github.com/playbors/playbor-admin-tools/issues/85))

### Feature

* goctl jwt  ([#91](https://github.com/playbors/playbor-admin-tools/issues/91))

### Fix

* golint: context.WithValue should should not use basic type as key ([#83](https://github.com/playbors/playbor-admin-tools/issues/83))


<a name="v1.0.15"></a>
## [v1.0.15](https://github.com/playbors/playbor-admin-tools/compare/v1.0.14...v1.0.15)

> 2020-09-18


<a name="v1.0.14"></a>
## [v1.0.14](https://github.com/playbors/playbor-admin-tools/compare/v1.0.13...v1.0.14)

> 2020-09-16

### Optimize

* api generating for idea plugin ([#68](https://github.com/playbors/playbor-admin-tools/issues/68))


<a name="v1.0.13"></a>
## [v1.0.13](https://github.com/playbors/playbor-admin-tools/compare/v1.0.12...v1.0.13)

> 2020-09-11


<a name="v1.0.12"></a>
## [v1.0.12](https://github.com/playbors/playbor-admin-tools/compare/v1.0.11...v1.0.12)

> 2020-09-08


<a name="v1.0.11"></a>
## [v1.0.11](https://github.com/playbors/playbor-admin-tools/compare/v1.0.10...v1.0.11)

> 2020-09-03


<a name="v1.0.10"></a>
## [v1.0.10](https://github.com/playbors/playbor-admin-tools/compare/v1.0.9...v1.0.10)

> 2020-09-03


<a name="v1.0.9"></a>
## [v1.0.9](https://github.com/playbors/playbor-admin-tools/compare/v1.0.8...v1.0.9)

> 2020-09-02

### Fix

* root path on windows bug ([#34](https://github.com/playbors/playbor-admin-tools/issues/34))


<a name="v1.0.8"></a>
## [v1.0.8](https://github.com/playbors/playbor-admin-tools/compare/v1.0.7...v1.0.8)

> 2020-09-01


<a name="v1.0.7"></a>
## [v1.0.7](https://github.com/playbors/playbor-admin-tools/compare/v1.0.6...v1.0.7)

> 2020-08-29


<a name="v1.0.6"></a>
## [v1.0.6](https://github.com/playbors/playbor-admin-tools/compare/v1.0.5...v1.0.6)

> 2020-08-25


<a name="v1.0.5"></a>
## [v1.0.5](https://github.com/playbors/playbor-admin-tools/compare/v1.0.4...v1.0.5)

> 2020-08-24


<a name="v1.0.4"></a>
## [v1.0.4](https://github.com/playbors/playbor-admin-tools/compare/v1.0.3...v1.0.4)
...
<a name="v1.0.3"></a>
## [v1.0.3](https://github.com/playbors/playbor-admin-tools/compare/v1.0.2...v1.0.3)

> 2020-08-14


<a name="v1.0.2"></a>
## [v1.0.2](https://github.com/playbors/playbor-admin-tools/compare/v1.0.1...v1.0.2)

> 2020-08-14


<a name="v1.0.1"></a>
## [v1.0.1](https://github.com/playbors/playbor-admin-tools/compare/v1.0.0...v1.0.1)
